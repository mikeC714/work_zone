...
try{
	...
	`<!DOCTYPE html>
	<html>
		<div style="background:#1a3a6b; padding:24px 32px; overflow:hidden;">
			...
			<p style="float:right; margin:0; color:#fff; font-size:28px; font-weight:bold; letter-spacing:4px;">QUOTE</p>
		</div>
		<div style="padding:28px 32px;">
			<div style="overflow:hidden; margin-bottom:28px;">
				...
				<div style="float:right; text-align:right; font-size:13px;">
		...
		<div style="overflow:hidden; margin-top:16px;">
			<table style="float:right; font-size:13px; min-width:220px;">
				<tr>
...
`;
	...
	console.log("FORMATTING PDF", pdfBuffer);

	console.log("FINISHED BUFFER RETURNED");
		return pdfBuffer;
	}catch(err){
		console.trace(err);
